...
async def generate_weekly_checkin(db: AsyncSession, user: User, session: ChatSession) -> ChatMessage:
    data_lines: list[str] = []
    ...
    if adherence is not None:
        data_lines.append(
            f"- Split adherence this week: {adherence.completed}/{adherence.planned} planned workouts completed."
        )
